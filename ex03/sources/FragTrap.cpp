...
FragTrap::FragTrap(const FragTrap &fragtrap): ClapTrap(fragtrap._name, fragtrap.HP, fragtrap.EP, fragtrap.AD)
{
	std::cout << "FragTrap " << fragtrap._name << " copy constructor called!" << std::endl;
}
