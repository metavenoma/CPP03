...
ScavTrap::ScavTrap(const ScavTrap &scavtrap): ClapTrap(scavtrap._name, scavtrap.HP, scavtrap.EP, scavtrap.AD)
{
	std::cout << "ScavTrap " << scavtrap._name << " copy constructor called!" << std::endl;
}
